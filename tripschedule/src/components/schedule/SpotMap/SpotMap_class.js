...
export default class Spotmap extends Component {
  ...
  a = this.props.spotListinfo; //array
  //methods
  //-----------------------------------------------------------------
  ...
  componentDidMount() {
    ...
    //  this.props.setSpotListinfo([...response.data]);
    let spotListinfo = this.props.spotListinfo; //array
    console.log(spotListinfo);
    ...
    //   new L.latLng([spotListinfo[0].lat, spotListinfo[0].lng])
    // );
    // let marker = new L.marker(new L.latLng([this.props.spotListinfo.coordinates]));
