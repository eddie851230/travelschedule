...
const SchduleList = () => {
    ...
    function shandleOnDragEnd(result){
    ...
    const morningSpot = everySpotinfo.filter((elem) => elem.dayTime === "morning");
    const afternoonSpot = everySpotinfo.filter((elem) => elem.dayTime === "afternoon");
    const eveningSpot = everySpotinfo.filter((elem) => elem.dayTime === "evening");
                ...
                {(provided) => (
                    <div ref={provided.innerRef} {...provided.droppableProps} >
                        <div className="morning">
                            ...
                            {/* <!-- 景點或飯店格 --> */}
                            {morningSpot.map(({ id, spotImg, spotName, duringTime, addr, href }, index) => (
                                <Draggable key={id} draggableId={id} index={index}>
                                    {provided => (
                                        <div className="spot" ref={provided.innerRef}
                        ...
                        <div className="afternoon">
                            ...
                            {afternoonSpot.map(({ id, spotImg, spotName, duringTime, addr, href }, index) => (
                                <Draggable key={id} draggableId={id} index={index}>
                                    {provided => (
                                        <div className="spot" ref={provided.innerRef}
                                            {...provided.draggableProps}
                        ...
                        <div className="evening">
                            ...
                            {eveningSpot.map(({ id, spotImg, spotName, duringTime, addr, href }, index) => (
                                <Draggable key={id} draggableId={id} index={index}>
                                    {provided => (
                                        <div className="spot" ref={provided.innerRef}
                                            {...provided.draggableProps}
